...
function addScriptAndCss()
{
	...
	wp_enqueue_script('owlcarousel-js', "https://cdnjs.cloudflare.com/ajax/libs/OwlCarousel2/2.2.1/owl.carousel.min.js","", true );
	...
	//wp_enqueue_style('mCustomScrollbar-css', get_theme_file_uri('/assets/css/jquery.mCustomScrollbar.css'));
}
add_action('wp_enqueue_scripts', 'addScriptAndCss');



/****************************START CREATING CUSTOM POST PORTFOLIO WITH CATEGORY ********************************/
...
/****************************END OF CREATING CUSTOM POST PORTFOLIO WITH CATEGORY ********************************/


/****************************START CREATING CUSTOM POST SERVICE WITH CATEGORY ********************************/
...
/****************************END OF CREATING CUSTOM POST SERVICE WITH CATEGORY ********************************/
...
function my_acf_google_map_api( $api ){
	...
	$api['key'] = 'AIzaSyC65W9P5_ffDcf0VCidQpra2GtZCBhoULk';
