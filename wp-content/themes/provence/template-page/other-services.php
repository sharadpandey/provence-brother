...
*/ 
get_header();
/*Getting  Other Service Banner Image */
...
<section class="section services-section other-services-page">
	<div class="container">
		<div class="row">
			<?php
			$i=1;
			$taxonomy_name = 'service_category';
			$termchildren = get_term_children( 21, $taxonomy_name );
				 ...
				 <div class="col-md-4 col-sm-4 col-xs-12">
                    <div class="service-post-cover">
                        ...
                        <div class="service-post-text">
                            <p><?php echo wp_trim_words( $term->description, 36);?></p>
                        </div> <a href="<?php echo get_category_link( $term->term_id ); ?>" class="red-btn" pd-data>See More</a>
					</div>
                </div>
